use super::helper::{absolute_width_with_padding, count_border_columns};
use super::{ColumnDisplayInfo, DisplayInfos};
use crate::style::{
    ColumnConstraint,
    ColumnConstraint::{Absolute, Boundaries, ContentWidth, Hidden, LowerBoundary, UpperBoundary},
    Width,
};
...
pub fn evaluate(
    ...
    if let Some(min_width) = min(table, column.constraint.as_ref(), visible_columns) {
