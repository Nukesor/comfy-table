...
///
/// All constants in this module consist of strings, with each character in the same position as the respective component in the [Component](table::Component) enum.
